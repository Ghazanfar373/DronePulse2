...
namespace MissionPlanner
{
    public class MAVLinkInterface : MAVLink, IDisposable, IMAVLinkInterface, IMAVLinkInterfaceLogRead
    {
        ...
        public BufferedStream hiddenLogfile { get; set; }
        ...
        public void Open(bool getparams, bool skipconnectedcheck = false, bool showui = true)
        {
            ...
            if (showui)
                frmProgressReporter = CreateIProgressReporterDialogue("Establishing Datalink ");
            else
...
Mission Planner waits for 2 valid heartbeat packets before connecting");
                ...
                if (getparams)
                {
                    frmProgressReporter.UpdateProgressAndStatus(0,
                        "Syncing... (sysid " + MAV.sysid + " compid " + MAV.compid + ") ");
            ...
            try
            {
                if (logfile != null && logfile.CanWrite && !logreadmode)
                {
                    lock (logfile)
                    {
                        ...
                        hiddenLogfile.Write(datearray, 0, datearray.Length);
                        hiddenLogfile.Write(packet.ToArray(), 0, packet.Length);
                    }
                }
            }
            catch
        ...
        public void getParamList()
        {
            ...
            frmProgressReporter = CreateIProgressReporterDialogue("JSR Datalink Params" + " " + sysidcurrent);
            frmProgressReporter.DoWork += FrmProgressReporterGetParams;
            frmProgressReporter.UpdateProgressAndStatus(-1, "JSR Datalink Params");
            frmProgressReporter.RunBackgroundOperationAsync();
            frmProgressReporter.Dispose();
        ...
        public async Task<MAVLinkParamList> getParamListAsync(byte sysid, byte compid)
        {
            ...
            do
            {
                ...
                //Let me decide weather it will be a dangerous or not
        ...
        public async Task<(PointLatLngAlt plla, int total)> getFencePoint(int no)
        {
            ...
            // request point I will not again
